...
To use the `useMedia` in your project, import `useMedia` from `@gluestack-ui/custom-design-system`. as Demonstrated below.

```jsx
import { useMedia } from '@gluestack-ui/custom-design-system';
```
